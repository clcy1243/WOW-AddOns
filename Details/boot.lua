...
--> global name declaration
		...
		_detalhes.build_counter = 4275
		_detalhes.userversion = "v7.2.5." .. _detalhes.build_counter
		_detalhes.realversion = 123 --core version
