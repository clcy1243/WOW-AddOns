...
function ToyPlus:Broker(self)
	...
	tooltip:AddLine('Left-click menu icon to toggle toy buttons.')
	tooltip:AddLine('Right-click menu icon for configuration.')
	tooltip:AddSeparator(1,0,0.5,1)
			...
			chkbox:SetScript("OnClick", function(self, button)
				if button == "LeftButton" then
					if InCombatLockdown() then 
						DEFAULT_CHAT_FRAME:AddMessage("ToyPlus: Error:\124cffffffff Can't do that while in combat.", 0, 0.7, 1)
