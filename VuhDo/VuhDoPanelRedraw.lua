...
do
	...
	local tModelArray;
	local tMemberNum;
	function VUHDO_getNumButtonsPanel(aPanelNum)
...
do
	...
	--
	function VUHDO_initBackgroundBar(aBgBar, aPanelNum)
...
do
	--
	function VUHDO_initIncomingOrShieldBar(aButton, aBarNum, aPanelNum)
	...
	--
	local tThreatBar;
	function VUHDO_initThreatBar(aButton, aPanelNum)
...
do
	...
	local tX;
	local tY;
	function VUHDO_initOverhealText(aHealthBar, aWidth, aPanelNum)
	...
	--
	local tAggroBar;
	function VUHDO_initAggroBar(aButton, aHealthBar, aPanelNum)
	...
	local tX;
	local tY;
	function VUHDO_initRaidIcon(aHealthBar, anIcon, aWidth, aPanelNum)
...
do
	...
	local tTgButton;
	local tTgHealthBar;
	function VUHDO_initTargetBar(aButton, aPanelNum)
	...
	--
	local tTotButton;
	function VUHDO_initTotBar(aButton, aHealthBar, aPanelNum)
...
do
	...
	--
	function VUHDO_initHighlightBar(aButton, aPanelNum)
...
do
	--
	local tBar;
	function VUHDO_initSideBarLeft(aButton, aHealthBar, aPanelNum)
	...
	--
	function VUHDO_initSideBarRight(aButton, aHealthBar, aPanelNum)
