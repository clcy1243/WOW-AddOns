...
VUHDO_MIN_TOC_VERSION = 120000;
VUHDO_MAX_TOC_VERSION = 130000;
...
VUHDO_I18N_AURA_GROUP_NAMES = {
	...
	["DISCIPLINE_PRIEST_HOTS"] = VUHDO_I18N_AURA_GROUP_DISCIPLINE_PRIEST_HOTS,
	["HOLY_PRIEST_HOTS"] = VUHDO_I18N_AURA_GROUP_HOLY_PRIEST_HOTS,
	["MISTWEAVER_MONK_HOTS"] = VUHDO_I18N_AURA_GROUP_MISTWEAVER_MONK_HOTS,
	["RESTORATION_SHAMAN_HOTS"] = VUHDO_I18N_AURA_GROUP_RESTORATION_SHAMAN_HOTS,
	["HOLY_PALADIN_HOTS"] = VUHDO_I18N_AURA_GROUP_HOLY_PALADIN_HOTS,
	["RAID_BUFFS"] = VUHDO_I18N_AURA_GROUP_RAID_BUFFS,
	["BLESSING_OF_BRONZE"] = VUHDO_I18N_AURA_GROUP_BLESSING_OF_BRONZE,
	["ROGUE_POISONS"] = VUHDO_I18N_AURA_GROUP_ROGUE_POISONS,
	["SHAMAN_WEAPON_IMBUEMENTS"] = VUHDO_I18N_AURA_GROUP_SHAMAN_WEAPON_IMBUEMENTS,
	["PALADIN_WEAPON_IMBUEMENTS"] = VUHDO_I18N_AURA_GROUP_PALADIN_WEAPON_IMBUEMENTS,
	["ENHANCEMENT_SHAMAN_BUFFS"] = VUHDO_I18N_AURA_GROUP_ENHANCEMENT_SHAMAN_BUFFS,
	["BREWMASTER_MONK_BUFFS"] = VUHDO_I18N_AURA_GROUP_BREWMASTER_MONK_BUFFS,
	["WARLOCK_METAMORPHOSIS"] = VUHDO_I18N_AURA_GROUP_WARLOCK_METAMORPHOSIS,
};
...
VUHDO_UPDATE_AURA_INFERENCE = 50;
...
-- Priest
	...
	[VUHDO_SPELL_ID.PREMONITION_OF_SOLACE] = true,
-- Druid
...
-- Monk
	...
	[VUHDO_SPELL_ID.ENVELOPING_BREATH] = true,
	[VUHDO_SPELL_ID.CHI_COCOON] = true,
	[VUHDO_SPELL_ID.ASPECT_OF_HARMONY] = true,
	[VUHDO_SPELL_ID.PURIFIED_SPIRIT] = true,
-- Evoker
	...
	[VUHDO_SPELL_ID.TEMPORAL_ANOMALY] = true,
	[VUHDO_SPELL_ID.ENKINDLE] = true,
	[VUHDO_SPELL_ID.SPIRITBLOOM] = true,
};
...
VUHDO_CUSTOM_GLOW_AURA_GROUP_KEY = "_AuGr_Frame";
VUHDO_AURA_GROUP_GLOW_ACTIVE_KEY = "_AuGr_Active";
...
VUHDO_SECRET_TYPE_NONE = 0;
VUHDO_SECRET_TYPE_BOOLEAN = 1;
VUHDO_SECRET_TYPE_HEALTH_PERCENT = 2;
VUHDO_SECRET_TYPE_POWER_PERCENT = 3;
VUHDO_SECRET_TYPE_DISPEL = 4;
VUHDO_SECRET_TYPE_DURATION = 5;
VUHDO_SECRET_TYPE_SPRITE_CELL = 6;
VUHDO_SECRET_TYPE_VALUES = 7;

VUHDO_FORCE_SECRETS_ENABLED = false;
VUHDO_SECRETS_ENABLED = VUHDO_FORCE_SECRETS_ENABLED or (issecretvalue ~= nil);
...
VUHDO_STATUSBAR_LEFT_TO_RIGHT = 1;
