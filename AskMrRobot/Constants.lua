...
Amr.SpecIcons = {
    ...
    [6] = "classicon_demonhunter_void", -- DemonHunterDevourer
    [7] = "spell_nature_starfall", -- DruidBalance
    [8] = "ability_druid_catform", -- DruidFeral
    [9] = "ability_racial_bearform", -- DruidGuardian
    [10] = "spell_nature_healingtouch", -- DruidRestoration
    [11] = "classicon_evoker_devastation", -- EvokerDevastation
    [12] = "classicon_evoker_preservation", -- EvokerPreservation
    [13] = "classicon_evoker_augmentation", -- EvokerAugmentation
    [14] = "ability_hunter_bestialdiscipline", -- HunterBeastMastery
    [15] = "ability_hunter_focusedaim", -- HunterMarksmanship
    [16] = "ability_hunter_camouflage", -- HunterSurvival
    [17] = "spell_holy_magicalsentry", -- MageArcane
    [18] = "spell_fire_firebolt02", -- MageFire
    [19] = "spell_frost_frostbolt02", -- MageFrost
    [20] = "spell_monk_brewmaster_spec", -- MonkBrewmaster
    [21] = "spell_monk_mistweaver_spec", -- MonkMistweaver
    [22] = "spell_monk_windwalker_spec", -- MonkWindwalker
    [23] = "spell_holy_holybolt", -- PaladinHoly
    [24] = "ability_paladin_shieldofthetemplar", -- PaladinProtection
    [25] = "spell_holy_auraoflight", -- PaladinRetribution
    [26] = "spell_holy_powerwordshield", -- PriestDiscipline
    [27] = "spell_holy_guardianspirit", -- PriestHoly
    [28] = "spell_shadow_shadowwordpain", -- PriestShadow
    [29] = "ability_rogue_eviscerate", -- RogueAssassination
    [30] = "inv_sword_30", -- RogueOutlaw
    [31] = "ability_stealth", -- RogueSubtlety
    [32] = "spell_nature_lightning", -- ShamanElemental
    [33] = "spell_nature_lightningshield", -- ShamanEnhancement
    [34] = "spell_nature_magicimmunity", -- ShamanRestoration
    [35] = "spell_shadow_deathcoil", -- WarlockAffliction
    [36] = "spell_shadow_metamorphosis", -- WarlockDemonology
    [37] = "spell_shadow_rainoffire", -- WarlockDestruction
    [38] = "ability_warrior_savageblow", -- WarriorArms
    [39] = "ability_warrior_innerrage", -- WarriorFury
    [40] = "ability_warrior_defensivestance", -- WarriorProtection
}

-- instance IDs ordered in preferred display order
Amr.InstanceIdsOrdered = { 2912, 2913, 2939 }
