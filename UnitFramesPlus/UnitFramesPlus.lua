...
function UnitFramesPlus_GetValueFix(valueCurr, valueMax, valueunit, unittype)
    ...
    elseif valueunit == 1 and unittype == 2 and (GetLocale() == "zhCN" or GetLocale() == "zhTW") then
        ...
        if valueLoss >= 100000000 then
            valueLossfix = (math.floor(valueLoss/10000000)/10)..unitbig;
        elseif valueMax >= 10000 then
            valueLossfix = math.floor(valueLoss/10000)..unitsmall;
        else
            valueLossfix = valueLoss;
        end
    else
        ...
        if valueMax >= 1000000 then
            valueMaxfix = math.floor(valueMax/1000000)..unitbig;
        ...
        if valueLoss >= 1000000 then
            valueLossfix = math.floor(valueLoss/1000000)..unitbig;
        elseif valueMax >= 1000 then
            valueLossfix = math.floor(valueLoss/1000)..unitsmall;
        else
            valueLossfix = valueLoss;
        end
    end
