                ...
                for id = 1, 4, 1 do
                    if UnitExists("party"..id) then
                        for j = 1, UFP_MAX_PARTY_BUFFS, 1 do
                            ...
                            local _, _, icon, _, _, duration, expires = UnitBuff("party"..id, j, filter);
                            if icon then
                                local timetext = "";
                        ...
                        for j = 1, UFP_MAX_PARTY_DEBUFFS, 1 do
                            local _, _, icon, count, _, duration, expires = UnitDebuff("party"..id, j);
                            if icon then
                                local counttext = "";
                                local timetext = "";
                                if count > 1 then
                        ...
                        for j = 1, UFP_MAX_PARTY_PET_DEBUFFS, 1 do
                            local _, _, icon, count, _, duration, expires = UnitDebuff("partypet"..id, j);
                            if icon then
                                local counttext = "";
                                local timetext = "";
                                if count > 1 then
