...
-- Target name
FontStyleBig = {"Interface\\AddOns\\oUF_Hank\\fonts\\monaco.ttf", 22, "THINOUTLINE"},
-- Power, absolute health
FontStyleMedium = {"Interface\\AddOns\\oUF_Hank\\fonts\\monaco.ttf", 14},
-- ToT, TToT, pet
FontStyleSmall = {"Interface\\AddOns\\oUF_Hank\\fonts\\monaco.ttf", 14},
-- Castbar: Time text, focus spell name
CastBarBig = {"Interface\\AddOns\\oUF_Hank\\fonts\\monaco.ttf", 15},
-- Castbar: Spell name (player, target)
CastBarMedium = {"Interface\\AddOns\\oUF_Hank\\fonts\\monaco.ttf", 9},
-- Castbar: Latency
CastBarSmall = {"Interface\\AddOns\\oUF_Hank\\fonts\\monaco.ttf", 8},
