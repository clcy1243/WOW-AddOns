...
local mod = AdiBags:NewModule("CaerdonWardrobeUpdate", "ABEvent-1.0")
...
-- 	CaerdonWardrobe:ProcessItem(itemID, bag, slot, true, true, nil, onItemProcessed)
...
local CaerdonWardrobeAdiBagsFrame = CreateFrame("FRAME")
